...
import me.wxwsk8er.Waly.Util.ParticleEffect.ParticleData;
import me.wxwsk8er.Waly.Util.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	public static final class ParticlePacket {
		 ...
		 * @see #ParticleEffect(ParticleEffect, float, float, float, float, int, boolean, ParticleData)
		 */
		public ParticlePacket(ParticleEffect effect, int amount, boolean longDistance) {
			this(effect, 0, 0, 0, 1, amount, longDistance, null);
		}
