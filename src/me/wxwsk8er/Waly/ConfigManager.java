...
public class ConfigManager {
    ...
    */
    ...
    /**
     * @return Lobby location from configuration.
     */
    public Location getLobbyLocation(){
    	YamlConfiguration a = (YamlConfiguration) this.getFileConfig("Maps.yml");
    	ConfigurationSection section = a.getConfigurationSection("lobby");
